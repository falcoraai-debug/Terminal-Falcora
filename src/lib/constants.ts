 ...
 */
export const APP_NAME: string = 'Terminal-Falcora';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Terminal Cast: Clean charts + AI caption + 1-tap Cast.';
 ...
 */
export const APP_TAGS: string[] = ['crypto', 'chart', 'trading', 'farcaster', 'ai', 'analysis', 'terminal', 'ema'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Open Terminal Cast';
